...
public class CloudVM {
    ...
    ArrayList<CloudVM> objHost = new ArrayList<CloudVM>();

    public ArrayList<CloudVM> getObjHost() {
        return objHost;
    }

    public void setObjHost(ArrayList<CloudVM> objHost) {
        this.objHost = objHost;
    }

             
    
     CloudVM(boolean Vf,int OsType,int ram,int imgSize,int NoOfCore){
